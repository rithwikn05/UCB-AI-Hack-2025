...
# REMOVED: from __main__ import completed_research
# We will now rely solely on the FastAPI polling endpoint /get-results/{request_id}
...
def test_hazard_recognition_accuracy_multi_agent_robust():
    ...
    test_cases = [
        {
            ...
            "longitude": -122.4194,
            "priority": "urgent",
            "expected_analysis_keywords": ["earthquake", "seismic", "wildfire", "fault", "urban"],
            "expected_button_keywords": ["earthquake", "wildfire", "seismic", "rupture"]
        },
        {
            ...
            "longitude": -80.1918,
            "priority": "urgent",
            "expected_analysis_keywords": ["hurricane", "flood", "coastal", "tropical", "storm"],
            "expected_button_keywords": ["hurricane", "storm surge", "flood", "coastal erosion"]
        },
        {
        ...
        },
        {
            ...
            "longitude": 138.7278,
            "priority": "urgent",
            "expected_analysis_keywords": ["volcano", "earthquake", "seismic", "eruption", "mountain"],
            "expected_button_keywords": ["volcanic eruption", "earthquake", "lava flow", "ashfall"]
        },
        {
            "name": "Bangladesh (Flood/Sea Level)",
            "latitude": 22.3475,
            "longitude": 91.8123,
            "priority": "comprehensive",
            "expected_analysis_keywords": ["flood", "sea level rise", "cyclone", "delta", "coastal", "tropical"],
    ...
    max_polling_attempts = 20 # Total wait time = polling_interval * max_polling_attempts (e.g., 2s * 20 = 40s)
    ...
    for i, test_case in enumerate(test_cases):
        ...
        try:
            ...
            if not final_report_data:
                print(f"❌ Timed out waiting for results for request_id: {request_id}")
